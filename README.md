...
## To install module manually by dragging up zip file, please download [.zip archive](https://plugin-documentation.postfinance-checkout.ch/pfpayments/prestashop-8/1.0.3/postfinancecheckout.zip) of module with correct structure required by Prestashop installation
...
* [English](https://plugin-documentation.postfinance-checkout.ch/pfpayments/prestashop-8/1.0.3/docs/en/documentation.html)
...
Please see the [license file](https://github.com/pfpayments/prestashop-8/blob/1.0.3/LICENSE) for more information.
